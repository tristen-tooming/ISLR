...
The file contains data from 215 samples of finely chopped meat. Your task is to compare PCR, PLS, Lasso and Ridge regression in which the 
fat content is regarded as target and the absorbance levels recorded in the 100 channels are regarded as explanatory variables.
