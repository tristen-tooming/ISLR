...
```{r Deep-Learning-Model-Standartization, cache=TRUE}
library(keras)
library(dplyr)
library(tfdatasets)
...
early_stop_lr <- callback_early_stopping(monitor = "val_loss", patience = 20)
...
plot(historylr$metrics$val_loss,xlab="Epoch",ylab="Val_loss", type = 'l', col="blue")
# Best validation MSE
...
Overall PPR perfoms best with MSE of 2.53. It was simple to use and tuning was a no brainer. Neural Networks were a hassle, took longer to configure and tuning was more a try and error. There wasn't informative graphs to look which could have supported the tuning decisions.
